...
Feature: Add payment to Order from Back Office (BO)
  ...
  Background:
    ...
    And I delete currency with iso code "EUR"
    And I delete currency with iso code "JPY"
    ...
    And currency "currency2" should have pattern "¤#,##0.00" for language "en-US"
    And currency "currency2" should have pattern "#,##0.00 ¤" for language "fr-FR"
    ...
    And I set the pattern "¤#,##0.00" for currency "currency3" in locale "en-US"
    And I set the pattern "#,##0.00 ¤" for currency "currency3" in locale "fr-FR"
    And currency "currency3" should have pattern "¤#,##0.00" for language "en-US"
    And currency "currency3" should have pattern "#,##0.00 ¤" for language "fr-FR"
